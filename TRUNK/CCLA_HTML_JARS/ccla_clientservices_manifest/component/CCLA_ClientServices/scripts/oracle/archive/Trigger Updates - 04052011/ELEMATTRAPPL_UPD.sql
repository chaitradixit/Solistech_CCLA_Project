...
declare
  ...
  $HeadURL: svn://eigg/stellent/CLIENTS/CCLA/Database/Central_Database/Triggers/ELEMATTRAPPL_UPD.sql $
  */
  v_ei_id number(10);
  v_eia_id   int;
begin
  ...
  if v_ei_id is not null and :new.attribute_status = 1then
