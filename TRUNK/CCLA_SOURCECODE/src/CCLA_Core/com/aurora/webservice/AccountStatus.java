...
public class AccountStatus implements java.io.Serializable {
    ...
    public static final java.lang.String _FROZ = "FROZ";
    public static final java.lang.String _CLOS = "CLOS";
    public static final AccountStatus Undefined = new AccountStatus(_Undefined);
    public static final AccountStatus OPEN = new AccountStatus(_OPEN);
    public static final AccountStatus FROZ = new AccountStatus(_FROZ);
    public static final AccountStatus CLOS = new AccountStatus(_CLOS);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ccla.co.uk/AuroraWS", "AccountStatus"));
    }
    /**
