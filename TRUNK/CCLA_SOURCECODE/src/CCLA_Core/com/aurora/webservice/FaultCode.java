...
public class FaultCode implements java.io.Serializable {
    ...
    public static final FaultCode Client = new FaultCode(_Client);
    public static final FaultCode Server = new FaultCode(_Server);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ccla.co.uk/AuroraWS", "FaultCode"));
    }
    /**
